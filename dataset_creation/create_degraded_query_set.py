...
versions are saved as .wav files and their start and end indices in the original 
...
def get_augmentation_loader(
    ...
    the GenerationLoaderAugment class."""
    ...
    loader = GenerationLoaderAugment(
...
def main(
    ...
    max_shift_len = max_shift_duration * fs  # TODO: int?
...
if __name__ == "__main__":
    ...
    # Create the loader
    query_loader = get_augmentation_loader(
        args.tracks_csv,
        args.tracks_dir,
        fs=args.fs,
