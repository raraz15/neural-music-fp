...
def get_fingerprinter(cfg: dict, trainable: bool = False) -> FingerPrinter:
    ...
    ----------
        cfg : dict
            Configuration dictionary created from the '.yaml' located in config/ directory.
            It should have the keys "MODEL" and "TRAIN", each containing another dictionary.
            "MODEL" should contain "ARCHITECTURE" with keys "EMB_SZ" and "BN".
            "TRAIN" should contain "MIXED_PRECISION".
        trainable : bool, optional
            If True, the returned FingerPrinter object will be trainable. Default is False.
...
def get_checkpoint_index_and_restore_model(
    ...
    # Load a particular checkpoint
        ...
        checkpoint_fpath = os.path.join(checkpoint_dir, f"ckpt-{checkpoint_index}")
